...
<body class="min-h-screen flex items-center justify-center relative p-4">
    ...
    <div class="w-full max-w-md z-10 animate-slide-up">
        ...
        <div class="text-center mt-6 z-10 relative">
            <div class="inline-block bg-slate-900/40 backdrop-blur-xs border border-slate-800/60 rounded-xl px-4 py-2 text-[10px] text-slate-400">
                Kredensial Demo: <strong class="text-blue-400">admin</strong> / <strong class="text-blue-400">admin123</strong>
            </div>
        </div>
